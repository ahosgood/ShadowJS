		...
		var Shadow = function() {
			...
			this.time = function() {
					...
					return {
							...
							m: datNow.getMinutes(),
							s: datNow.getSeconds(),
							ms: datNow.getMilliseconds(),
							tz: datNow.getTimezoneOffset(),
							utc: {
									d: datNow.getUTCDate(),
									m: datNow.getUTCMonth(),
									y: datNow.getUTCFullYear(),
									h: datNow.getUTCHours(),
									m: datNow.getUTCMinutes(),
									s: datNow.getUTCSeconds(),
									ms: datNow.getUTCMilliseconds()
								}
						};
				};
