...
(
	function( window ) {
		var Shadow = function() {
			...
			this.iPad = function () {
					return this.contains( 'iPad', navigator.userAgent );
				},
			this.iPod = function () {
					return this.contains( 'iPod', navigator.userAgent );
				},
			this.iPhone = function () {
					return this.contains( 'iPhone', navigator.userAgent );
				},
